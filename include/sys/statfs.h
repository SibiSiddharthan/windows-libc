...
#define MNT_STRICTTIME  0x00000100 // Update atime relative to mtime/ctime.
#define MNT_UNION       0x00000200 // Union with underlying filesystem.
#define MNT_ASYNC       0x00000400 // Writes are asynchronous.
#define MNT_REMOVABLE   0x00000800 // Filesystem is removable.
