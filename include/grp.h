...
WLIBC_API struct group *wlibc_getgruid(gid_t gid);
...
WLIBC_INLINE struct group *getgruid(gid_t gid)
{
	return wlibc_getgruid(gid);
}
...
WLIBC_API int wlibc_getgruid_r(gid_t gid, struct group *restrict grp_entry, char *restrict buffer, size_t size,
...
WLIBC_INLINE int getgruid_r(gid_t gid, struct group *restrict grp_entry, char *restrict buffer, size_t size, struct group **restrict result)
{
	return wlibc_getgruid_r(gid, grp_entry, buffer, size, result);
}
