...
#define WLIBC_BASIC_PERMISSIONS   (READ_CONTROL | SYNCHRONIZE | DELETE | FILE_DELETE_CHILD)
#define WLIBC_READ_PERMISSIONS    (FILE_READ_DATA | FILE_READ_ATTRIBUTES | FILE_READ_EA | WLIBC_BASIC_PERMISSIONS)
#define WLIBC_WRITE_PERMISSIONS   (FILE_WRITE_DATA | FILE_WRITE_ATTRIBUTES | FILE_WRITE_EA | FILE_APPEND_DATA | WLIBC_BASIC_PERMISSIONS)
